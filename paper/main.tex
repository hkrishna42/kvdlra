...
low-rank approximation (DLRA), a rank-adaptive online subspace tracker that is
near-oracle where Oja's rule is $1.3$--$3\times$ worse and whose error bound is
independent of the smallest tracked singular value. A rank-adaptive BUG tracker on the (pre-RoPE) KV stream
...
(16K) toward its $2r/n=0.125\times$ asymptote ($0.133\times$ at 64K, $19\%$ under
the 2-bit arm's $0.156\times$), where the flagship still retrieves all four tasks
...
fourteen fall in the first ingest chunk---with a mid/late tail, scattered misses
the quantizers do not make. We therefore state the matched-bytes
