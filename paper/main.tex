...
(\S\ref{sec:marquee}). Two provenance items remain for v2: the sub-cliff cell
(\S\ref{sec:subcliff}, $0.043\times$) and the 1B composition frontier are the
earlier Week-11 (8B) and Week-15 (1B) material, not the September run; and a
formal compute-disclosure appendix (the per-family seed/window/depth grid) is not
yet written.
